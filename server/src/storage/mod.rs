...
pub trait KeyStore {
    ...
    async fn get_one_time_ec_pre_key_count(&self, service_id: &Aci) -> Result<u32, KeyStoreError>;

    async fn get_one_time_pq_pre_key_count(&self, service_id: &Aci) -> Result<u32, KeyStoreError>;
}
